...
BIOBERT_NER_MODEL_DIR = "./biobert_ner/final_model"
BIOBERT_RE_MODEL_DIR = "biobert_re/final_model"

# =====BioBERT Model for NER======
biobert_ner_labels = get_labels('dataset_ner/labels.txt')
